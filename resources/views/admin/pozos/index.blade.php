        ...
        <div class="space-y-1.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-[1fr_8rem_8rem_8rem_6rem_5rem] gap-2 items-center
                ...
                <div class="flex gap-1 justify-center">
                    ...
                    <form method="POST" action="{{ route('admin.pozos.destroy', $pozo->id) }}" id="form-pozo-{{ $pozo->id }}">
                        @csrf @method('DELETE')
                        <button type="button"
                                @click="$store.confirmModal.show('¿Desactivar el pozo «{{ addslashes($pozo->nombre) }}»?', () => document.getElementById('form-pozo-{{ $pozo->id }}').submit())"
